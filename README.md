...
- **Nerd Font in your terminal**: Required for filetype and UI icons to render correctly (e.g., JetBrainsMono Nerd Font, FiraCode Nerd Font).
...
- **Clipboard**:
  ...
  - `<leader>V`: Paste _before_ from system clipboard.
- **Discover Keymaps**:
